            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gradient-to-r from-purple-50 to-blue-50">
                  <TableHead className="whitespace-nowrap font-bold">Client Country</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Client Name</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Project Name</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Assigned To</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Tech Stack</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Budget</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Milestone</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Status</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Completion %</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Remarks</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Start/End Date</TableHead>
                  <TableHead className="whitespace-nowrap font-bold">Next Action</TableHead>
